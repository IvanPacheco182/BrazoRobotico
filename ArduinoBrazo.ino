...
LiquidCrystal_I2C lcd(0x27, 16, 2);   //establece la dirección de la pantalla LCD en 0x27 para una pantalla de 16 caracteres y 2 líneas
...
void colocarPosicionInicial() { //Método que asignará una posición inicial a los servos
  ...
  codo.write(90);   //El servo del codo a 0 grados
}
